        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 text-right">
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#" className="text-gray-600 hover:text-gray-900">{t('footer.aboutUs')}</a></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#" className="text-gray-600 hover:text-gray-900">{t('footer.help')}</a></li>
              <li><a href="#" className="text-gray-600 hover:text-gray-900">{t('footer.contact')}</a></li>
              <li><a href="#" className="text-gray-600 hover:text-gray-900">{t('footer.community')}</a></li>
            </ul>
          </div>
          <div>
          ...
          <div>
            <h3 className="font-semibold text-gray-900 mb-4">{t('footer.social')}</h3>
